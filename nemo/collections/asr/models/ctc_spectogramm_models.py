...
from nemo.collections.asr.data import spectogramm_to_text_dataset
from nemo.collections.asr.data.spectogramm_to_text_dali import DALIOutputs
...
class EncDecCTCSpecModel(ASRModel, ExportableEncDecModel, ASRModuleMixin):
    ...
    def _setup_dataloader_from_config(self, config: Optional[Dict]):
        ...
        spectogramm_to_text_dataset.inject_dataloader_value_from_model_config(self.cfg, config, key='sample_rate')
        spectogramm_to_text_dataset.inject_dataloader_value_from_model_config(self.cfg, config, key='labels')
        ...
        dataset = spectogramm_to_text_dataset.get_char_dataset(config=config, augmentor=augmentor)
    ...
    def setup_training_data(self, train_data_config: Optional[Union[DictConfig, Dict]]):
        ...
        Supported Datasets:
            -   :class:`~nemo.collections.asr.data.spectogramm_to_text.AudioToCharDataset`
            -   :class:`~nemo.collections.asr.data.spectogramm_to_text.AudioToBPEDataset`
            -   :class:`~nemo.collections.asr.data.spectogramm_to_text.TarredAudioToCharDataset`
            -   :class:`~nemo.collections.asr.data.spectogramm_to_text.TarredAudioToBPEDataset`
            -   :class:`~nemo.collections.asr.data.spectogramm_to_text_dali.AudioToCharDALIDataset`
        """
