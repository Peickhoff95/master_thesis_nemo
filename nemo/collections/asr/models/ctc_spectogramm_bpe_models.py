...
__all__ = ['EncDecCTCSpecModelBPE']


class EncDecCTCSpecModelBPE(EncDecCTCSpecModel, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config(self, config: Optional[Dict]):
        ...
        dataset = spectogramm_to_text_dataset.get_bpe_dataset(
    ...
    def change_vocabulary(self, new_tokenizer_dir: Union[str, DictConfig], new_tokenizer_type: str):
        ...
        del self.decoder
        self.decoder = EncDecCTCSpecModelBPE.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
